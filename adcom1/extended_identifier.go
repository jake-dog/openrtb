...
type ExtendedIdentifier struct {
	...
	//   This should be the same value as used to identify sellers in an ads.txt file if one exists.<br>For ad tech intermediaries, this would be the domain as used in ads.txt. For publishers, this would match the domain in the 'site' or 'app' object.
